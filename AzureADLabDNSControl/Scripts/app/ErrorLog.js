$(function () {
    var getData = function (callback) {
        SiteUtil.AjaxCall("/api/ErrorLog/GetErrorItems?count=100", null , function (res) {
            callback(res);
        });
    }
    var errTable;
    ...
    $(".btn-primary").on("click", function () {
        var data = JSON.stringify({ ErrorId: $("#ErrorDialog").data("ErrorId") });
    ...
    var showDetailDialog = function (data) {
                ...
                if (col=='ErrorDate') {
                    ...
                    switch(col) {
                        case "Email":
                            ...
                            ds = "<a href='mailto:" + ds + "?subject=CSAHub Bug'>" + ds + "</a>";
                            break;
                        case "UserComment":
        ...
        $("#ErrorDialog").data("ErrorId", data.Id).modal('show');
    };
});
